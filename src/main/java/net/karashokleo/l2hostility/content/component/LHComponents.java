...
public class LHComponents implements EntityComponentInitializer, ChunkComponentInitializer
{
    ...
    public static final ComponentKey<MobDifficultyComponent> MOB_DIFFICULTY = ComponentRegistry.getOrCreate(L2Hostility.id("mob_trait"), MobDifficultyComponent.class);
