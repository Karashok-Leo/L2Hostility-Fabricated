...
import net.karashokleo.l2hostility.content.recipe.BurntRecipeBuilder;
...
//                    .offerTo(exporter, ID_UTIL.get(MiscItems.ETERNAL_WITCH_CHARGE));
        ...
        {
            enchantment(LHEnchantments.INSULATOR, 1, MiscItems.CHAOS_INGOT)
                    .pattern("AIA")
                    .pattern("DBD")
                    .pattern("ACA")
                    .input('B', Items.BOOK)
                    ...
                    .input('A', ComplementItems.FORCE_FIELD)
                    .input('C', ConsumableItems.BOTTLE_SANITY)
                    .offerTo(exporter, ID_UTIL.get("insulator"));

            enchantment(LHEnchantments.SPLIT_SUPPRESS, 1, MiscItems.CHAOS_INGOT)
                    .pattern("AIA")
                    .pattern("DBD")
                    .pattern("ACA")
                    .input('B', Items.BOOK)
                    ...
                    .input('A', ComplementItems.GUARDIAN_EYE)
                    .input('C', ConsumableItems.BOTTLE_SANITY)
                    .offerTo(exporter, ID_UTIL.get("split_suppress"));

            enchantment(LHEnchantments.SHULKER_ARMOR, 1, ComplementItems.SHULKERATE.nugget())
                    .pattern("LCL")
                    .pattern("ABA")
                    .pattern("LAL")
                    .input('A', ComplementItems.SHULKERATE.nugget())
                    .input('B', Items.BOOK)
                    .input('C', Items.GLASS)
                    .input('L', Items.LAPIS_LAZULI)
                    .offerTo(exporter, ID_UTIL.get("shulker_armor"));
        }
        ID_UTIL.popPrefix();
    ...
    {
        return RecipeTemplate.unlock(EnchantmentRecipeBuilder.create(enchantment, level)::criterion, item);
    }
